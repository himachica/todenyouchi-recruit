                                ...
                                <section id="hawto" class="section">
                                    ...
                                    <div class="section-contents">
                                        <div class="section-tbl">
                                            <dl class="section-tbl-item">
                                                <dt>応募方法</dt>
                                                <dd>以下の応募書類をエントリーフォームからご提出ください。<br>
                                                    ※応募の秘密は厳守します。また ご提出いただく個人情報については採用選考以外の目的には使用いたしません。<br><br><a href="<?php echo get_template_directory_uri(); ?>/assets/file/【東電用地】応募書類.xlsx">【東電用地】応募書類.xlsx</a><br>
                                                    書類選考結果については、1ヶ月以内を目途に、E-mailにて通知いたします。<br>
                                                    以降の選考の詳細は、各選考通過者のみにご連絡いたします。<br>
                                                    ※選考の経過に関するご質問についてはお答えできません。</dd>
                                            </dl>
                                            <dl class="section-tbl-item">
                                                <dt>提出書類</dt>
                                            ...
                                            <dl class="section-tbl-item">
                                                <dt>お問い合わせ先</dt>
                                                <dd>〒116－0013<br>東京都荒川区西日暮里2－25－1<br>ステーションガーデンタワー5F<br>東電用地(株)人材開発グループ　採用担当<br><br><br>TEL：03－6371－1108<br>受付時間9：00～17：00（土日祝を除く）<br>
